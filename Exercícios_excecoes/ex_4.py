...
- Valores sem erro: lista1 = [4,6,7,9,10]; lista2 = [-4,6,8,7,9]
- Listas com tamanhos diferentes: lista1 = [4,6,7,9,10,4]; lista2 = [-4,6,8,7,9]
- Listas com valores incoerentes: lista1 = [4,6,7,9,'A']; lista2 = [-4,'E',8,7,9]'''

def agrupa_lista(lista_1, lista_2):
    try:
        if len(lista_1) == len(lista_2):
            tupla = [(lista_1[i], lista_2[i], lista_1[i]+lista_2[i]) for i in range(len(lista_1))]
        else:
...
lista1 = [4,6,7,9,'A'] 
lista2 = [-4,'E',8,7,9]
print(agrupa_lista(lista1, lista2))